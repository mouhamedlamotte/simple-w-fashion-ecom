          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                <h1 className="text-5xl font-bold tracking-tight text-balance lg:text-6xl">WOMEN</h1>
              ...
              <div className="flex items-baseline gap-3">
                <span className="text-3xl font-bold text-primary">{formatCurrency(30000)}</span>
                <span className="text-lg text-muted-foreground line-through">{formatCurrency(50000)}</span>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute inset-0 flex items-center justify-center p-10">
                <Image
                  src="fashion.svg?height=300&width=300"
                  alt="Fashion Model"
                  width={500}
                  height={500}
